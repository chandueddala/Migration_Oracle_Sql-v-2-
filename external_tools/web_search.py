...
try:
    ...
    print("=" * 70)
    print("âš ï¸  WARNING: tavily-python package not installed")
    print("=" * 70)
...
class WebSearchHelper:
    ...
    def search_error_solution(self, error_message: str, object_type: str, 
        ...
        try:
            ...
            print(f"    ðŸ” Searching web for solutions...")
            ...
            print(f"    ðŸ“š Found {len(formatted_results['sources'])} web resources")
    ...
    def format_for_llm(self, search_results: Optional[Dict]) -> str:
        ...
        output_parts = [
            "\n" + "="*70,
            "ðŸŒ WEB SEARCH RESULTS - TOP SOLUTIONS FROM INTERNET",
            "="*70
        ]
